    ...
    def process(self, input_statement, additional_response_selection_parameters=None):
        ...
        if not response_list:
            ...
            alternate_response_list = list(
                self.chatbot.storage.filter(**alternate_response_selection_parameters)
            )
        ...
        if response_list:
            ...
            response = self.select_response(
                input_statement, response_list, self.chatbot.storage
            )
            ...
            response = self.select_response(
                input_statement, alternate_response_list, self.chatbot.storage
            )
